 ...
 */
public class SFtpCompressBulkUploadBehavior  extends AbstractSFtpBehavior{
		...
		final Set<String> processList = new HashSet<String>();
 		...
 		if(dir.isDirectory()){
 			...
 			if(fileList.length >0){
				...
				FileObject localFileObject = manager.resolveFile(dir.getAbsolutePath()+ "/" + file.getAbsoluteFile().getName());
